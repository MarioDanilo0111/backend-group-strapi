...
async function getDataFromStrapi() {
  //Url till Strapi.js API form sida monitors
...
async function postData() {
  ...
  const urlProduct = "http://localhost:1337/api/monitors/";

  // Hämtar data från fält på .html
...
//metod för validering av inloggninfsförsök
...
function generateRow(obj, objId, header) {
  ...
  if (!header && obj) {
    ...
    let postURL = `http://localhost:1337/api/monitors/${objId}`;
